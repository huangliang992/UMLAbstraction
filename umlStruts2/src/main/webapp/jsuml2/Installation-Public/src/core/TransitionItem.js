 ...
 **
 ** DESCRIPTION:
 **   This class represents a field of transition element of UML 2.
 **
 ** DEVELOPED BY:
...
TransitionItem.prototype.encode = function( values ) {
  ...
  //Tests if the text resulting has the format of the regular expression 'this._parse'
...
TransitionItem.prototype.showDialog = function() {
  ...
  this.changeText = function ( event ) {
	...
	//Function asociated to the close of dialog
