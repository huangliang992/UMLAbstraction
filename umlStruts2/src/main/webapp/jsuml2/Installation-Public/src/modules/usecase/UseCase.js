...
/**
 * UseCase class constructor, define the properties and methods of a UMLUseCase in the activity diagram
 *
...
var UseCase = function( params ) {

  params = params || {};
  UseCase.baseConstructor.call(this,params);
}
...
UseCase.prototype.addStereotype = function(text){
	var text = text || '';
...
UseCase.prototype.setName = function( text ){
