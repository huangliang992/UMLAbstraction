...
/**
 * SubSystem class constructor, define the properties and methods of a UMLSubSystem in the activity diagram
 *
...
var SubSystem = function( params ) {

  params = params || {};
  SubSystem.baseConstructor.call(this,params);
}
...
SubSystem.prototype.addStereotype = function(text){
	var text = text || '';
...
SubSystem.prototype.setName = function( text ){
