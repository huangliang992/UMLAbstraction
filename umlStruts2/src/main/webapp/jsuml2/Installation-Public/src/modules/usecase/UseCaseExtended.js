...
/**
 * UseCaseExtended class constructor, define the properties and methods of a UMLUseCaseExtended in the activity diagram
 *
 * @author Rafael Molina Linares
 * @update 13/10/2011
 *
 * @class UseCaseExtended
 * @extends Rectangular
 *
 */

var UseCaseExtended = function( params ) {

  params = params || {};
  UseCaseExtended.baseConstructor.call(this,params);
}
...
UseCaseExtended.prototype.addStereotype = function(text){
	var text = text || '';
...
UseCaseExtended.prototype.setName = function( text ){
...
/**
 * Create a new item in the text fields component that stores a list of extension's points
 *
 * @author Rafael Molina Linares
 * @update 16/11/2011
 *
 * @method addExtensionPoint
 * @param {String} text Text of new item to establish
 *
 */

UseCaseExtended.prototype.addExtensionPoint = function( text ){
...
/**
 * Return the list of extension's points of the element UML
 *
 * @author Rafael Molina Linares
 * @update 16/11/2011
 *
 * @method getExtensionPoints
 * @return {Array} Array with the extension points of the element UML
 *
 */
